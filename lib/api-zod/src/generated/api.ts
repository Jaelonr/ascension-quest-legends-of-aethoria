...
export const SetupPlayerBody = zod.object({
  ...
  "weightGoal": zod.enum(['lose', 'maintain', 'gain']).optional(),
...
export const UpdateWorkoutSessionBody = zod.object({
  ...
  "notes": zod.string().nullish(),
  "completedAt": zod.string().nullish(),
  "narrativeIntensity": zod.enum(['technical', 'balanced', 'immersive']).optional()
})
...
export const GenerateWorkoutPlanBody = zod.object({
  "goal": zod.enum(['strength', 'hypertrophy', 'conditioning', 'striking', 'grappling', 'recovery', 'mobility', 'skill_practice', 'commission', 'back_friendly_lower']),
...
export const claimBossRaidRewardResponseGearDropXpBonusPercentMin = 0;
export const claimBossRaidRewardResponseGearDropXpBonusPercentMax = 10;
...
export const ClaimBossRaidRewardResponse = zod.object({
  ...
  "playerId": zod.number(),
  "name": zod.string(),
  "slot": zod.enum(['weapon', 'offhand', 'helmet', 'chest', 'gloves', 'boots', 'ring', 'necklace', 'armor', 'wraps', 'relic', 'cloak', 'title', 'aura_cosmetic']),
  "rarity": zod.enum(['common', 'uncommon', 'rare', 'epic', 'legendary']),
  "statBonuses": zod.object({
  "strength": zod.number().optional(),
  ...
  "xpBonusPercent": zod.number().min(claimBossRaidRewardResponseGearDropXpBonusPercentMin).max(claimBossRaidRewardResponseGearDropXpBonusPercentMax).optional(),
  "cosmeticKey": zod.string().nullish(),
  "cosmeticVariant": zod.string().nullish(),
  "displayName": zod.string().nullish(),
  "iconUrl": zod.string().nullish(),
  "iconKey": zod.string().nullish(),
  "mannequinLayerUrl": zod.string().nullish(),
  "mannequinLayerKey": zod.string().nullish(),
  "layerOrder": zod.number().nullish(),
  "loreText": zod.string().nullish(),
 ...
 */
export const getArmoryResponseXpBonusPercentMin = 0;
export const getArmoryResponseXpBonusPercentMax = 10;
...
export const GetArmoryResponseItem = zod.object({
  ...
  "elementalAffinity": zod.string().optional(),
  "narrativeModifiers": zod.array(zod.string()).optional(),
  "xpBonusPercent": zod.number().min(getArmoryResponseXpBonusPercentMin).max(getArmoryResponseXpBonusPercentMax).optional(),
  "cosmeticKey": zod.string().nullish(),
  "cosmeticVariant": zod.string().nullish(),
  "displayName": zod.string().nullish(),
  "iconUrl": zod.string().nullish(),
...
export const SearchFoodResponseItem = zod.object({
  ...
  "fat100g": zod.number(),
  "fiber100g": zod.number().nullish(),
  "sugar100g": zod.number().nullish(),
  "sodiumMg100g": zod.number().nullish(),
  "servingSize": zod.string().nullish(),
  "servingGrams": zod.number().nullish(),
  "category": zod.string().optional(),
  "source": zod.enum(['guild_compendium', 'open_food_facts']).optional()
})
...
export const GetGuildMasterCampaignQuestsResponse = zod.array(GetGuildMasterCampaignQuestsResponseItem)
...
/**
 * @summary Get the complete Chronicle hub summary
 */
export const getChronicleSummaryResponseWorldDangerValueMin = 0;
export const getChronicleSummaryResponseWorldDangerValueMax = 100;



export const GetChronicleSummaryResponse = zod.object({
  "worldDanger": zod.object({
  "value": zod.number().min(getChronicleSummaryResponseWorldDangerValueMin).max(getChronicleSummaryResponseWorldDangerValueMax),
  "state": zod.enum(['critical', 'severe', 'unstable', 'guarded', 'recovering']),
  "label": zod.string(),
  "defeatedBosses": zod.number(),
  "activeThreats": zod.number(),
  "failedIncursions": zod.number(),
  "systemNote": zod.string(),
  "nextRelief": zod.string()
}).optional(),
  "battleReplays": zod.array(zod.object({
  "id": zod.number(),
  "playerId": zod.number().optional(),
  "sessionId": zod.number().nullish(),
  "encounterName": zod.string(),
  ...
  "guildReports": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
  "campaignProgress": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
  "discoveredItems": zod.array(zod.object({
  "id": zod.number(),
  "itemName": zod.string(),
  "rarity": zod.string(),
  "category": zod.string(),
  ...
  "bossesDefeated": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
...
/**
 * @summary Get unified character identity summary
 */
export const GetCharacterSummaryResponse = zod.object({
  "player": zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "level": zod.number(),
  ...
  "gearSlots": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
  "titles": zod.array(zod.record(zod.string(), zod.unknown())).optional(),
  "realEquipment": zod.array(zod.record(zod.string(), zod.unknown())).optional()
})


/**
 * @summary Get the complete daily Guild Hall snapshot
 */
export const getGuildHallTodayResponseWorldDangerValueMin = 0;
export const getGuildHallTodayResponseWorldDangerValueMax = 100;



export const GetGuildHallTodayResponse = zod.object({
  "date": zod.string(),
  "player": zod.object({
  "id": zod.number(),
  "name": zod.string(),
  ...
  "worldDanger": zod.object({
  "value": zod.number().min(getGuildHallTodayResponseWorldDangerValueMin).max(getGuildHallTodayResponseWorldDangerValueMax),
  "state": zod.enum(['critical', 'severe', 'unstable', 'guarded', 'recovering']),
  "label": zod.string(),
  "defeatedBosses": zod.number(),
  "activeThreats": zod.number(),
  ...
  "trendSummary": zod.record(zod.string(), zod.unknown()).optional(),
  ...
  "id": zod.number(),
  "name": zod.string(),
  "elementalAffinity": zod.string(),
  "narrativeModifiers": zod.array(zod.string()),
  "xpBonusPercent": zod.number()
})),
  "hallOfferings": zod.record(zod.string(), zod.unknown()).optional(),
  "readiness": zod.record(zod.string(), zod.unknown()).optional(),
  "consequences": zod.array(zod.object({
  "id": zod.number(),
  "tier": zod.enum(['minor', 'major', 'critical']),
  "outcome": zod.string(),
  "canRestore": zod.boolean(),
  "restorationQuestId": zod.number().nullish(),
  "occurredAt": zod.string().optional()
})),
  "worldEvents": zod.array(zod.object({
  "id": zod.number(),
...
/**
 * @summary Report daily commission progress and claim earned rewards idempotently
 */
export const reportToGuildMasterResponseSnapshotWorldDangerValueMin = 0;
export const reportToGuildMasterResponseSnapshotWorldDangerValueMax = 100;



export const ReportToGuildMasterResponse = zod.object({
  "reported": zod.boolean(),
  "alreadyReported": zod.boolean(),
  "counsel": zod.string().optional(),
  "remainingTasks": zod.array(zod.object({
  "id": zod.number().optional(),
  "description": zod.string().optional()
})).optional(),
  "rewards": zod.object({
  ...
  "statPoints": zod.number().optional()
}).optional(),
  "aldric": zod.object({
  "tone": zod.string().optional(),
  "counsel": zod.string().optional(),
  "memoryReferences": zod.array(zod.string()).optional(),
  "practicalRecommendation": zod.string().optional(),
  "warning": zod.string().nullish(),
  "rewardSummary": zod.string().optional(),
  ...
  "worldDanger": zod.object({
  "value": zod.number().min(reportToGuildMasterResponseSnapshotWorldDangerValueMin).max(reportToGuildMasterResponseSnapshotWorldDangerValueMax),
  "state": zod.enum(['critical', 'severe', 'unstable', 'guarded', 'recovering']),
  "label": zod.string(),
  "defeatedBosses": zod.number(),
  "activeThreats": zod.number(),
...
/**
 * @summary Begin an available restoration campaign
 */
export const StartRestorationQuestParams = zod.object({
  "id": zod.coerce.number()
})


/**
 * @summary Import deduplicated Apple Health or Health Connect records
 */
export const importHealthDataBodyEventsMax = 500;



export const ImportHealthDataBody = zod.object({
  "source": zod.enum(['apple_health', 'health_connect']),
  "events": zod.array(zod.object({
  ...
  "restingHr": zod.number().nullish(),
  "caloriesBurned": zod.number().nullish(),
  "activeMinutes": zod.number().nullish(),
  "weight": zod.number().nullish()
})).min(1).max(importHealthDataBodyEventsMax)
})

export const ImportHealthDataResponse = zod.object({
  "source": zod.string(),
  "imported": zod.number(),
