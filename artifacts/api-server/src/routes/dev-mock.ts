...
const buildMockGuildHall = () => ({
  ...
  commission: {
    ...
    expedition: {
      ...
      recommendedPath: { id: "build_endurance", label: "Build endurance workout", kind: "workout_builder", intendedStyle: "conditioning", completionPath: "endurance_workout", recommended: true },
      alternativePaths: [
