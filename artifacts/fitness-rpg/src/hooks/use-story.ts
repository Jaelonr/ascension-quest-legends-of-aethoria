...
export const STORY_ARCS: StoryArc[] = [
  ...
  },
  {
    ...
    levelRange: [5, 9],
    lore: "The outskirts of Aethoria — once green and peaceful, now overrun with Malachar's scouting beasts. Wolves, goblins, and corrupted creatures stalk the farmlands. The villagers whisper of a Hunter who might drive them back.",
    danger: 80,
  ...
  },
  {
    ...
    levelRange: [50, 999],
    lore: "You stand at the gates of Malachar's fortress. Every hunter before you has fallen here. But you trained when they rested. You pushed when they quit. The world of Aethoria — and your own world — watches. End it.",
    danger: 12,
    color: "text-red-400",
  },
];
...
export const STORY_BOSSES: StoryBoss[] = [
  ...
  },
  {
    ...
    levelRequired: 22,
    arc: 3,
    lore: "Mireya poisoned the forest's rivers on Malachar's orders. Her cauldron feeds the corruption spreading through Miremoor. Hunters fear her — her magic is ancient and cruel.",
    weaknesses: ["Discipline", "Resistance"],
    reward: "Miremoor rivers cleansed. +6000 XP. Title: Witch Hunter",
  },
  {
    id: "shadowwolf",
    ...
    levelRequired: 28,
    arc: 3,
    lore: "The alpha of a pack of shadow wolves that numbers in the hundreds. Where it goes, darkness follows. It has devoured three A-rank hunters who came before you.",
